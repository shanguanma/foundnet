...
from foundnet.models.transformer import TransformerFrontend
from foundnet.nn.transformer.incremental_state import IncrementalStateBag
from foundnet.nn.transformer.normalization import LayerNorm, StandardLayerNorm
from foundnet.nn.transformerposition_encoder import PositionEncoder
from foundnet.nn.transformer.projection import Linear
from foundnet.utils.mask import to_padding_mask
...
class Wav2Vec2Frontend(TransformerFrontend):
    ...
    def __init__(
        ...
        *,
        ...
        layer_norm: bool = True, ## final input of transformer encoder should be layer norm  
        dropout_p: float = 0.1,
